...
public class TestServlet extends HttpServlet {
	...
	static {
		System.out.println("test servlet controller is loading");
	}
	public TestServlet(){
		System.out.println("test servlet object instantiated");
	}
	public void init() { 
		System.out.println("test servlet object is loaded with confog object data ");
	}
